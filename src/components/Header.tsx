    ...
    <header style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="22" height="22" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0, overflow: 'visible' }}>
            <g transform="translate(-30.845,-36.494) scale(0.29428)">
